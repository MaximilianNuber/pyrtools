...
Welcome to `pyrtools` contributor's guide.
...
If you experience bugs or general issues with `pyrtools`, please have a look
...
You can help improve `pyrtools` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`pyrtools` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `pyrtools`'s files. While this mechanism can
...
```
conda create -n pyrtools python=3 six virtualenv pytest pytest-cov
conda activate pyrtools
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/pyrtools.git
   cd pyrtools
   ```
...
5. Install [pre-commit]:
   ...
   `pyrtools` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/pyrtools
[issue tracker]: https://github.com/<USERNAME>/pyrtools/issues
